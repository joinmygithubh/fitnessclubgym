      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl group bg-[#11141c]">
              <img
                src="/owner.jpg"
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <span className="editorial-tag text-[10px] bg-amber-500 text-black px-3 py-1 rounded-full font-bold inline-block">
            ...
            <div className="flex justify-center pt-1">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/5 hover:bg-amber-500/10 border border-white/10 hover:border-amber-500/40 text-slate-200 hover:text-amber-400 font-display font-bold text-xs uppercase tracking-widest transition-all shadow-md group"
              >
