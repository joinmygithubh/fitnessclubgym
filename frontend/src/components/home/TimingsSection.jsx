  ...
  return (
    <section className="py-28 lg:py-36 bg-[#08090c] border-b border-white/10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {/* Header */}
        <ScrollReveal variant="fade-up" delay={0} className="text-center space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <ScrollReveal variant="slide-right" delay={100}>
            <div className="p-10 sm:p-12 rounded-3xl bg-[#11141c] border border-white/10 hover:border-amber-500/40 card-hover-effect text-center space-y-6 group">
              <div className="w-16 h-16 rounded-full bg-amber-500/10 text-amber-400 mx-auto flex items-center justify-center group-hover:scale-110 group-hover:bg-amber-500/20 transition-all duration-300">
                <Sun className="w-8 h-8" />
              </div>

              <div className="space-y-1">
                <span className="editorial-tag text-[10px] text-slate-400 block">
                  SESSION <AnimatedCounter value="01" />
                </span>
          ...
          <ScrollReveal variant="slide-left" delay={200}>
            <div className="p-10 sm:p-12 rounded-3xl bg-[#11141c] border border-white/10 hover:border-amber-500/40 card-hover-effect text-center space-y-6 group">
              <div className="w-16 h-16 rounded-full bg-sky-500/10 text-sky-400 mx-auto flex items-center justify-center group-hover:scale-110 group-hover:bg-sky-500/20 transition-all duration-300">
                <Moon className="w-8 h-8" />
              </div>

              <div className="space-y-1">
                <span className="editorial-tag text-[10px] text-slate-400 block">
                  SESSION <AnimatedCounter value="02" />
                </span>
